...
public final class ActivityBillAddBinding implements ViewBinding {
  ...
  private ActivityBillAddBinding(@NonNull ConstraintLayout rootView, @NonNull Button Addition,
      ...
      @NonNull Button btn8, @NonNull Button btn9, @NonNull ConstraintLayout fragment,
      @NonNull GridLayout gridLayout, @NonNull View line, @NonNull TextView notes,
      @NonNull ImageView pgbar, @NonNull Button point, @NonNull View symbol,
  ...
  @NonNull
  public static ActivityBillAddBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBillAddBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bill_add, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBillAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBillAddBinding((ConstraintLayout) rootView, Addition, Again, Clear, Finish,
          Subtraction, billdate, billledger, btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8,
          btn9, fragment, gridLayout, line, notes, pgbar, point, symbol, typeA, typeR);
    }
